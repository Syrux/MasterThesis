tiff("MmEsLpMiss_lastPos_NoPPIC.png", width=18, height=9, units='in', res=120)
...
one <- c(57251, 62971, 64247, 68604, 92617, 132273, 168278, 219716, 302063, 708680)/1000

#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(52, 1092))
lines(x, one, col="red", type="o", pch=1)
title(main="BIBLE", cex.lab=1.5, cex.axis=1.5, cex.main=1.5, cex.sub=1.5)
grid()
legend("bottomright", legend=c("BaseSpark", "lastPos_NoPPIC"), lty=c(1,1),lwd=c(2,2), col=c("blue", "red"), cex = 1)
...
one <- c(237424, 295879, 395786, 520362)/1000

#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(237, 536))
lines(x, one, col="red", type="o", pch=1)
...
one <- c(32420, 32080, 36021, 41805, 44025, 55484)/1000

#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(14, 55))
lines(x, one, col="red", type="o", pch=1)
...
one <- c(3713, 3877, 4417, 5162, 6797, 6454, 8472, 10114, 18092, 44843)/1000
...
one <- c(12506, 13774, 16624, 24189, 40220, 77156)/1000
...
one <- c(67485, 96850, 254842, 357743, 650649, 1095734, 1842227, 3897483)/1000
...
one <- c(22914, 35394, 51768, 54421, 56881, 55189, 65617, 61134, 60876)/1000
...
one <- c(22672, 25716, 29842, 44593, 49100, 52728, 57001, 70322, 71980)/1000

#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(13, 71))
lines(x, one, col="red", type="o", pch=1)
