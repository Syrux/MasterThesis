...
one <- c(240123, 306535, 430516, 519567)/1000

#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(240, 530))
lines(x, one, col="red", type="o", pch=1)
...
one <- c(29304, 31698, 34518, 39096, 43527, 50453)/1000
