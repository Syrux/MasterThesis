tiff("MmEsLpMiss_first_lastPos_NoPPIC.png", width=18, height=9, units='in', res=120)
...
one <- c(52726, 55286, 55855, 63733, 84355, 110988, 137774, 187753, 263900, 584497)/1000
...
grid()
legend("bottomright", legend=c("BaseSpark", "firstLastPos_NoPPIC"), lty=c(1,1),lwd=c(2,2), col=c("blue", "red"), cex = 1)
...
one <- c(234877, 305027, 405640, 520924)/1000
...
one <- c(32020, 34389, 37029, 41384, 47252, 56612)/1000
...
one <- c(3624, 3626, 4146, 4666, 5066, 5905, 7372, 10299, 15683, 36539)/1000
...
one <- c(11931, 13923, 15687, 24014, 39083, 72956)/1000

#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(6, 72))
lines(x, one, col="red", type="o", pch=1)
...
one <- c(54714, 75425, 176057, 248614, 432697, 718622, 1149499, 2439468)/1000
...
one <- c(23241, 32777, 44198, 48526, 50625, 49852, 58785, 56067, 56923)/1000
...
one <- c(25330, 28799, 33542, 45456, 49855, 53844, 58931, 71956, 76033)/1000
