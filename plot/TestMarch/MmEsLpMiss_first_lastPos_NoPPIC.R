...
one <- c(312246, 434722, 532022, 660175)/1000

#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(312, 697))
lines(x, one, col="red", type="o", pch=1)
...
one <- c(28659, 32920, 33905, 38783, 43564, 50649)/1000
