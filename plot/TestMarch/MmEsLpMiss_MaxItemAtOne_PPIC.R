...
one <- c(234200, 300092, 409706, 529295)/1000

#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(234, 530))
lines(x, one, col="red", type="o", pch=1)
...
one <- c(19974, 19864, 23642, 23174, 26705, 29502)/1000
