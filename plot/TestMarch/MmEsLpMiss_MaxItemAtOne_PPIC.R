tiff("MmEsLpMiss_MaxItemAtOne_PPIC.png", width=13, height=9, units='in', res=120)
...
one <- c(25468, 25299, 27646, 28716, 32508, 37824, 46734, 54019, 76390, 181579)/1000
...
grid()
legend("bottomright", legend=c("BasePPIC", "MaxItem_PPIC"), lty=c(1,1),lwd=c(2,2), col=c("blue", "red"), cex = 1)
...
one <- c(312473, 442639, 545352, 683804)/1000

#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(312, 726))
lines(x, one, col="red", type="o", pch=1)
...
one <- c(16300, 17305, 18358, 19880, 22071, 25233)/1000
...
one <- c(3256, 3298, 5815, 3512, 3780, 4144, 4528, 5296, 6635, 10178)/1000
...
one <- c(9662, 11067, 11082, 13114, 19144, 30595)/1000

#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(4, 32))
lines(x, one, col="red", type="o", pch=1)
...
one <- c(28564, 29545, 36558, 41357, 47951, 57919, 72352, 115346)/1000
