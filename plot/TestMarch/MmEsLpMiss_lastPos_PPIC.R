...
one <- c(235901, 303927, 406530, 496255)/1000
...
one <- c(25797, 27586, 30275, 34992, 37916, 45927)/1000

#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(10, 45))
lines(x, one, col="red", type="o", pch=1)
