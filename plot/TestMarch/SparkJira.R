tiff("SparkJira.png", width=18, height=9, units='in', res=120)
...
one <- c(23369, 20175, 21040, 23738, 24623, 29845, 35764, 44398, 60009, 145250)/1000
...
grid()
legend("bottomright", legend=c("BaseSpark", "Improved_version"), lty=c(1,1),lwd=c(2,2), col=c("blue", "red"), cex = 1)
...
one <- c(307021, 444755, 570330, 719730)/1000

#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(307, 719))
lines(x, one, col="red", type="o", pch=1)
...
one <- c(16638, 18229, 19110, 20317, 22155, 25099)/1000
...
one <- c(2822, 2782, 2842, 3052, 3397, 3503, 4052, 4414, 5416, 8141)/1000
...
one <- c(8956, 9336, 10249, 11539, 16225, 25284)/1000
...
one <- c(23201, 24925, 30657, 33265, 38083, 44532, 56105, 78123)/1000

#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(23, 5160))
lines(x, one, col="red", type="o", pch=1)
...
one <- c(16148, 17981, 21171, 22193, 24595, 25519, 29340, 31913, 32135)/1000
...
one <- c(19346, 21970, 24495, 27409, 31411, 31715, 35497, 41780, 44965)/1000

#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(13, 44))
lines(x, one, col="red", type="o", pch=1)
