tiff("MaxItemPerItemset_recalculated.png", width=9, height=9, units='in', res=120)
...
#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(23, 186))
lines(x, one, col="red", type="o", pch=1)
title(main="BIBLE", cex.lab=1.5, cex.axis=1.5, cex.main=1.5, cex.sub=1.5)
grid()
legend("bottomright", legend=c("reference", "Miss_recalculated"), lty=c(1,1),lwd=c(2,2), col=c("blue", "red"), cex = 1)
...
#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(307, 696))
lines(x, one, col="red", type="o", pch=1)
...
#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(15, 27))
lines(x, one, col="red", type="o", pch=1)
...
#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(2, 11))
lines(x, one, col="red", type="o", pch=1)
...
#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(9, 33))
lines(x, one, col="red", type="o", pch=1)
...
#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(26, 119))
lines(x, one, col="red", type="o", pch=1)
...
one <- c(17756, 21232, 24403, 25222, 28131, 27799, 30392, 34730, 32069)/1000

#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(15, 34))
lines(x, one, col="red", type="o", pch=1)
...
one <- c(17356, 19254, 21766, 25798, 27851, 28637, 32271, 36581, 39713)/1000

#PLOT
plot(x, zero, log = "xy", type="o", pch=0, xlab="Minsup(%)",ylab="Time (s logscale)", col="blue", xlim = rev(range(x)), ylim=c(13, 39))
lines(x, one, col="red", type="o", pch=1)
