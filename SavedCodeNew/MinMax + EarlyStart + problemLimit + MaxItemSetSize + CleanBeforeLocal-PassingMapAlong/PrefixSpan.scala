...
object PrefixSpan extends Logging {
    ...
    if (numSmallPrefixes > 0) {
      ...
      val distributedFreqPattern = postfixes.flatMap { postfix =>
        ...
        if (cleaningResult._3) {
          ...
          // TODO: We collect projected postfixes into memory.
          // TODO: We should also compare the performance
   ...
   */
  private[fpm] def cleanSequences(postfixes: Iterable[Postfix],
    prefix: Prefix, minSupport: Long):
  (Array[Postfix], mutable.Map[Int, Int], Boolean) = {
